...
const categories = [
  ...
  },
  {
    ...
    icon: Database,
    color: 'cyan',
    skills: ['MySQL', 'Git', 'GitHub', 'Vite', 'PM2', 'ESLint', 'Axios', 'Vercel'],
  },
  {
    title: 'Special',
    icon: Cpu,
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {categories.map((cat, i) => {
            ...
            return (
              ...
              >
                {/* Card header */}
                <div className={`bg-gradient-to-r ${colors.headerBg} to-transparent px-6 py-5 border-b border-white/5 flex items-center gap-3`}>
