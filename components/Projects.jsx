...
const projects = [
  ...
  },
  {
    ...
    links: [
      { label: 'Frontend', url: 'https://github.com/Eslamawd/wholesale-front-react' },
      { label: 'Backend', url: 'https://github.com/Eslamawd/wholesale-app-backend-laravel' },
    ],
    accent: 'purple',
  },
  {
...
export default function Projects() {
  ...
  return (
    <section id="projects" className="py-24 px-4 sm:px-6 lg:px-8 bg-slate-100 dark:bg-[#0d0d1a]">
      <div className="max-w-7xl mx-auto" ref={ref}>
        ...
        >
          ...
          <p className="mt-6 text-slate-400 max-w-xl mx-auto">
            A selection of projects I&apos;ve built — from AI-powered trading bots to full-stack
